...
CREATE TABLE IF NOT EXISTS `administrator` (
  ...
  `phone` varchar(16) COLLATE utf8_bin DEFAULT NULL COMMENT '座机号',
...
CREATE TABLE IF NOT EXISTS `teacher` (
  ...
  `photo` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '照片地址',
  ...
  `idcardno` varchar(20) COLLATE utf8_bin DEFAULT NULL COMMENT '身份证号',
  `address` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT '住址',
  `email` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT 'email，可输入多个，用;分割',
  `postgraduateschool` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '研究生院校',
  `postgraduatefaculty` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '研究生院系',
  `postgraduatemajor` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '研究生专业',
  `postgraduatedegree` varchar(10) COLLATE utf8_bin DEFAULT NULL COMMENT '研究生阶段获得学位',
  `postgraduateend` varchar(20) COLLATE utf8_bin DEFAULT NULL COMMENT '研究生毕业日期',
  `collegeschool` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '本科院校',
  `collegefaculty` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '本科院系',
  `collegemajor` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '本科专业',
  `collegedegree` varchar(10) COLLATE utf8_bin DEFAULT NULL COMMENT '本科阶段获得学位',
  `collegeend` varchar(20) COLLATE utf8_bin DEFAULT NULL COMMENT '本科毕业日期',
  ...
  `researchgroup` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '所属课题组，可多选，用;分割',
...
CREATE TABLE IF NOT EXISTS `student` (
  ...
  `labaddr` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT '实验室地址',
  ...
  `hobby` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT '特长爱好',
  `introduction` varchar(1000) COLLATE utf8_bin DEFAULT NULL COMMENT '个人简介',
  `postgraduateschool` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '研究生院校',
  `postgraduatefaculty` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '研究生院系',
  `postgraduatemajor` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '研究生专业',
  ...
  `collegedegree` varchar(10) COLLATE utf8_bin DEFAULT NULL COMMENT '本科阶段获得学位',
  `collegeend` varchar(20) COLLATE utf8_bin DEFAULT NULL COMMENT '本科毕业日期',
  `seniorschool` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '高中学校',
  `seniorstart` varchar(20) COLLATE utf8_bin DEFAULT NULL COMMENT '高中入学日期',
  `seniorend` varchar(20) COLLATE utf8_bin DEFAULT NULL COMMENT '高中毕业日期',
  `researchgroup` varchar(20) COLLATE utf8_bin NOT NULL COMMENT '所属课题组',
  `lab` varchar(20) COLLATE utf8_bin NOT NULL COMMENT '所在实验室',
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
...
CREATE TABLE IF NOT EXISTS `person` (
  ...
  `status`  varchar(4) COLLATE utf8_bin NOT NULL COMMENT '状态，在校，离校',
  `note` varchar(255) COLLATE utf8_bin COMMENT '备注',
  PRIMARY KEY (`uid`),
  UNIQUE KEY `uid` (`uid`)
...
CREATE TABLE IF NOT EXISTS `patent` (
  `id` varchar(10) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '专利ID',
  `time` int(11) NOT NULL COMMENT '录入系统时间',
  `title` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '专利标题',
  `abstract` varchar(1000) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '专利摘要',
  `image1` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '代表图片1的路径',
  `image2` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '代表图片2的路径',
  `image3` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '代表图片3的路径',
  `application` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '申请书文件地址',
  `status` varchar(1) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '当前状态',
  `acceptnum` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '专利受理号',
  `acceptdate` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '受理日期',
  `notice` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '受理通知书地址',
  `authorizationnum` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '授权号',
  `authorizationdate` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '授权日期',
  `authorizationcertificate` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '授权证书地址',
  `subsidize` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '资助者列表，以;分割',
